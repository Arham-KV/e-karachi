...
function Cart() {
    ...
    const buyNow = async () => {
        ...
        const stripe = await loadStripe("//addy your stripe public key here");
        ...
        try {
            ...
            if (result.error) {
                ...
                // Dispatch action to set payment status to 'success' in Redux store
                dispatch(setPaymentStatus('success'));
    ...
    return (
        <Layout>
            <div className=" py-7" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                {cartItem.length === 0 ? (
                                    ...
                                    return (
                                        <div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                                            ...
                                            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                                ...
                                                <div onClick={() => deleteCart(item)} className="mt-4 flex justify-between sm:space-y-6 cursor-pointer sm:mt-0 sm:block sm:space-x-6">
